...
public class 배열1 {
	...
	public static void main(String[] args) {
		 ...
		 * 타입[] 배열이름 = {값, 값, 값, 값}; //선언과 동시에 초기화 일때만 가능
		 * - 배열의 길이는 0이상이어야 한다. -는 안됨.
		 * - 배열의 시작번지는 0부터 시작
		 * 배열[3] => 0 1 2
		 * 
		 * */
		...
		arr1[0]=1;//배열에 값을 저장하고 출력하는 법 
		arr1[1]=2;
		arr1[2]=3;
		System.out.println(arr1[0]);
		System.out.println(arr1[1]);
		System.out.println(arr1[2]); //풀어서 쓴 것 for문으로 간단하게 표현
