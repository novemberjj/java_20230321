...
public class Date01 {
	...
	public static void main(String[] args) {
		 ...
		 * 직접 객체를 생성할 수 없음
		 * new 연산자를 통해 객체 구현 X
		 * getInstacne()를 이용하여 구현한 클래스를 통해 인스턴스를 얻어옴
		 * 
		 * month : 0월 ~ 11월 까지 밖에 없어서 무조건 +1
		 * week : 1=일, 2=월 ...
		 * am_pm : am=0, pm=1
		 * */
//		Date d= new Date();
...
//		잘 사용하지 않음
		...
		System.out.println(week); //일 월 화 수 목 금 ...
...
//		
//		if(noon==1) {
//			System.out.println("오후 "+hour+":"+minute);
//		}else {
//			System.out.println("오전 "+hour+":"+minute);
//		}
