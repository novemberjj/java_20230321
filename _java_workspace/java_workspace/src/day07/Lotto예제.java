...
public class Lotto예제 {
	...
	public static void main(String[] args) {
		 ...
		 * 당첨번호 = 당첨번호 6자리+1자리 (1~45) 마지막 생성번호가 보너스 번호
		 * 
	...
	/* 4. 같은 값이 들어가지않게 체크
	 * 리턴타입 : 배열에 생성한 랜덤값이 있는지 체크(있으면 true, 없으면 false)
	 * 매개변수 : int arr[], random
	 * 메서드명 : isContain
	 * */
	...
	public static int ranking(int[] lotto, int[] user) {
		...
		case 5: 
			...
			return(isContain(user, lotto[lotto.length-1])? 2 : 3); //삼항연산자 이용
		case 4: return 4;
