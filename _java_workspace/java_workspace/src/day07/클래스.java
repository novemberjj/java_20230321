...
public class 클래스 {
	...
	public static void main(String[] args) {
		 ...
		 * - 일반적으로 private으로 선언된 멤버변수는 getter/setter을 통해 변수에 접근할 수 있음.
		 * */
		
		Point p = new Point(); //선언해야 사용가능
		p.print();
		p.move(10, 3);
		p.print();
		
		//p.x=7;//public이라 내마음대로 바꿀 수 있음
		//p.y=10;//private은 직접 접근 안됨
		p.print();
...
class Point{
	...
	//x,y 좌표를 변경하는 메서드
	//매개변수 : x,y의 값을 주고 멤버변수의 x,y룰 변경
	public void move(int x, int y) {
		this.x=x; //똑같을때만 this 붙여주면 됨
		this.y=y;
	}
	public int getX() {
...
class Point1{
	...
	//x,y,z를 찍는 print 메서드 생성
	public void print(){//메서드명은 같아도 상관없음
