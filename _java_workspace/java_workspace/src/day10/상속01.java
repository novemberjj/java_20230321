...
public class 상속01 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * class B extends A{ //A클래스를 B에게 물려주겠다
		 * 
		 * }
		 * 상속키워드 : extends
		 * 
		 * 상속을 받으면 부모의 멤버변수와 메서드를 사용할 수 있다.
		 * 접근제한자 private은 접근 불가능.
...
class B extends A{ //a,b,c(직접 접근 불가능 get/setter로 접근 가능),num(직접 접근 가능),d,e,f 모두 사용가능
	private int d,e,f;
	
	//오버라이드 : 부모의 메서드를 재정의하여 사용하는 것을 의미
	@Override
	public void print() {
		super.print(); //super : 부모의 값을 가져올때
