...
public class 클래스05 {
	...
	public static void main(String[] args) {
		/* static이 붙은 멤버 변수/메서드들을 클래스 멤버/메서드라고 한다.
		 ...
		 * - 객체 멤버 메서드는 객체 멤버 메서드에서만 사용할 수 있다.
		 * */
		
		TV t= new TV();
		t.printPower();
		t.powerOn();
		//객체메서드 접근방식 : 객체 생성 후 객체명.메서드명()
		t.printPower();
...
class TV{
	...
	public static void printBrand() { //메서드에 static을 붙이면 static 붙은 애들만 사용가능
		System.out.println("제조사:"+brand);
		//System.out.println(power);//클래스메서드에 객체 변수를 사용 불가능
	}
	public void powerOn() {
		power=true;
	}
