...
public class BigDecimalEx {
	...
	public static void main(String[] args) {
		...
		//BigInteger : 정밀한 숫자를 처리해야 할 때 
		BigInteger bi= BigInteger.valueOf(100000); //일반 int로 형변환
